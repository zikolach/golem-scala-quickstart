...
// These classes are generated by golem-scalajs-wit-bindgen based on wit file
// see target/scala-2.13/src_managed/main/scala/golem.example/Api.scala
...
//  case class success(orderConfirmation: OrderConfirmation)
